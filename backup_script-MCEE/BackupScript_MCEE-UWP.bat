...
set "source=%USERPROFILE%\AppData\Local\Packages\Microsoft.MinecraftEducationEdition_8wekyb3d8bbwe"
set "destination=%~dp0"
set "folderName=Microsoft.MinecraftEducationEdition_!currentDate!"
